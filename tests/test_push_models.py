...
class PushSubscriptionModelTests(unittest.TestCase):
    def test_valid_browser_subscription_is_accepted(self):
        ...
        self.assertEqual(model.endpoint, "https://fcm.googleapis.com/wp/device")
    ...
    def test_keys_are_required_bounded_and_extra_identity_is_forbidden(self):
        invalid_payloads = (
            {"endpoint": "https://fcm.googleapis.com/wp/device", "keys": {"p256dh": "", "auth": "a"}},
            {"endpoint": "https://fcm.googleapis.com/wp/device", "keys": {"p256dh": "p", "auth": ""}},
            {"endpoint": "https://fcm.googleapis.com/wp/device", "keys": {"p256dh": "p", "auth": "a"}, "user_id": 999},
            {"endpoint": "https://fcm.googleapis.com/wp/device", "keys": {"p256dh": "p", "auth": "a", "family_id": 888}},
        )
